...
const modelPath = "models/roll_chair.glb";
...
//   });
  ...
  const INITIAL_MAP = [
    { name: "cushions", childID:"Object_4",  mtl: null },
    { name: "Body", childID:"Object_5",  mtl: null },
    { name: "Bezel", childID:"Object_6",  mtl: null },
  ]
  ...
  return (
    <>
    <Canvas camera={{fov: 75}} shadows  className="webgl">
      <ambientLight  />
